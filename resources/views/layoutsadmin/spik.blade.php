...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                  <h2>
                    KONFIRMASI SURAT IJIN KERAMAIAN
                  </h2>
            </div>
                <div class="body">
                    <form class="row g-2 m-3" action="/postspik/{{$sr->id}}" method="POST">
                         {{csrf_field()}}
                                 @method('PUT')
                                    ...
                                    <div class="col-lg-3 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Hari</label>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Hiburan</label>
                                    </div>
                                    <div class="col-lg-9 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                    ...
                                    <div class="col-lg-9 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                               <input type="text" name="alamat_hiburan" class="form-control">
                                            </div>
                                            @error('alamat_hiburan')
                                    <label id="email-error" class="error" for="email" style="display: block;">{{$message}}</label>
                                    @enderror
                                        </div>
                                    </div>
