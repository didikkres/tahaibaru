...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                  <h2>
                    KONFIRMASI SURAT KETERANGAN USAHA
                  </h2>
            </div>
                <div class="body">
                    <form class="row g-2 m-3" action="/postsku/{{$sr->id}}" method="POST">
                         {{csrf_field()}}
                                 @method('PUT')
                                    ...
                                    <h2 class="card-inside-title">DATA USAHA</h2>
                                    <div class="col-lg-3 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Nama Usaha</label>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Jenis Usaha</label>
                                    </div>
                                    <div class="col-lg-9 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                    ...
                                    <div class="col-lg-3 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Alamat Usaha</label>
                                    </div>
                                    <div class="col-lg-9 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
